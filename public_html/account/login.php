                ...
                <section class="form-input-container">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control username-input" name="user_identifier" id="user_identifier" placeholder="Username / Email Address / Contact Number" value="" autocomplete="off">
